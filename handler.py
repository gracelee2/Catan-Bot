...
def getState(game):
    playerBoard = [[0] * 21 for _ in range(11)]
    opposingBoard = [[0] * 21 for _ in range(11)]
    ...
    for key in game.current_player.hand:
        state.append([[game.current_player.hand[key]] * 21 for _ in range(11)])

    state.append([[len(game.current_player.cities)] * 21 for _ in range(11)])
    state.append([[game.current_player.played_knights] * 21 for _ in range(11)])
    state.append([[game.current_player.point_cards] * 21 for _ in range(11)])
